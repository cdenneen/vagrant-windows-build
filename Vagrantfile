...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # first attempt 180 day eval win2k8r2 with sp2 manually added
  # config.vm.box_url = "https://googledrive.com/host/0ByE9o2VXQ6TnVWt3MjA2MXlHcnc/"
  # second attempt win2k8r2sp1 fresh install
  config.vm.box_url = "https://googledrive.com/host/0ByE9o2VXQ6TnT0ZXcnJMdk9RY0E/"
  ...
  config.vm.provision :shell, inline: "cinst git puppet -Version 3.3.1"
